...
/* (b) Tworzenie populacji
    Co robi:
    Tworzy tablicę o długości length, wypełnioną losowymi zerami i jedynkami.
    Każdy element:
      1 oznacza, że dany przedmiot jest wybrany do plecaka
      0 oznacza, że dany przedmiot jest pominięty
    Przykład wyniku:
    Jeśli masz 5 przedmiotów, przykładowy wynik może być:
    [1, 0, 1, 1, 0]
    (to znaczy: pierwszy, trzeci i czwarty przedmiot wybrane, drugi i piąty nie).
*/
...
/* Tworzy populację rozwiązań – czyli wiele takich losowych chromosomów.
Argumenty:
size: ile chromosomów (osobników) w populacji, np. 100
chromLength: ile genów (czyli ile przedmiotów, np. 50)
Wynik:
Tablica obiektów, gdzie każdy obiekt ma:
    genes (np. [0, 1, 1, 0, ...])
    value: 0 (fitness, na razie nieobliczone)
    weight: 0 (waga, na razie nieobliczona)

Przykładowy wynik dla 3 osobników i 5 przedmiotów:
    [
      { genes: [1, 0, 1, 0, 1], value: 0, weight: 0 },
      { genes: [0, 1, 1, 1, 0], value: 0, weight: 0 },
      { genes: [1, 1, 0, 0, 1], value: 0, weight: 0 }
    ]

Każdy osobnik to losowa propozycja, które przedmioty włożyć do plecaka.
Populacja to zbiór wielu takich rozwiązań, które potem będą „walczyć” w algorytmie genetycznym.
*/
...
// (c) Funkcja przystosowania (fitness)
...
// (g) Pętla algorytmu genetycznego
